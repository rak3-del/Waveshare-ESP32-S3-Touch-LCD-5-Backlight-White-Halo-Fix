...
#### Special thanks to 赵玉娇 from Waveshare support for reproducing the issue and providing the hardware fix.

## Hardware Fix: ⚠️ This requires soldering. Proceed at your own risk.
...
On the back of the board, near the LCD connector (pin 40 area), cut the trace shown in the Photo (the diagonal line indicates where to cut).
